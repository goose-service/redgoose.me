	...
	@if($repo->state === 'success')
		...
		<nav class="external-control">
			...
			<button type="button" id="closeArticle" title="Close article" class="close">
				<img src="{{ __ROOT__ }}/assets/img/ico-close.svg" class="close__ico close__ico-pc" alt="close"/>
				<img src="{{ __ROOT__ }}/assets/img/ico-close2.svg" class="close__ico close__ico-mobile" alt="close"/>
			</button>
		</nav>
		@endif
	@else
